...
def attack(char_name: str, char_class: str) -> str:
    """Set logic of scores for attack accruing based on char class."""
...
def defence(char_name: str, char_class: str) -> str:
    """Set logic of scores for defence accruing based on char class."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Set logic of scores for special trick accruing based on char class."""
    if char_class == 'warrior':
        return ((f'{char_name}'
...
def start_training(char_name: str, char_class: str) -> str:
    """Training introduction, techniques explanation."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Give the user option of different chars."""
    approve_choice: str = ''
    char_class: str = ''
...
def main() -> str:
    """Aggregated function for all previous defs."""
